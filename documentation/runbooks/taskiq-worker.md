...
Only the conversation-retention pass (section 4) records a durable outcome row in the product
...
- `reconcile-and-reclamation.md` — the levers for inspecting the fleet and running the sweep on
  demand.
