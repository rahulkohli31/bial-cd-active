/**
 * Build-chat persistence guards, re-expressed against the session model (U5).
 *
 ...
 *   - the user turn — INCLUDING its attachment parts — is persisted via appendBuilderMessage BEFORE
 *     the build starts, so BRAIN reads the image/PDF/office/deck context server-side (C3 §2.1).
 */
