/**
 * DataClassificationModal (V4, task-sheet "Part 1"): six weighted Yes/No toggles,
 * an escalating warning shown only once every question is answered, the notes
 * gate at the >=25 soft threshold, and a Cancel that is structurally isolated
 * from Confirm (backdrop/Escape/button all resolve to the same `onCancel`, none
 * of them reachable from `onConfirm`).
 */
