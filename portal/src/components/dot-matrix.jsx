...
const STATES = {
 idle: { color:"text-neutral", base: 0.3 },
 ...
 paused: { color:"text-neutral", glyph: PAUSE },
 stopped: { color:"text-neutral", glyph: STOP },
 offline: { color:"text-neutral", base: 0.15 }
};

const dotMatrixStates = Object.keys(STATES);
