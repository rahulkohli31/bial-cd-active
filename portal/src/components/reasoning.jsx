...
const reasoningVariants = cva("aui-reasoning-root mb-4 w-full", {
  variants: {
    variant: {
      ...
      ghost: "",
      muted: "bg-oklch(0.97 0 0)/50 rounded-lg px-3 py-2 dark:bg-oklch(0.269 0 0)/50",
    },
  },
  defaultVariants: {
    variant: "outline",
...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger text-oklch(0.556 0 0) hover:text-oklch(0.145 0 0) flex max-w-[75%] origin-left items-center gap-2 py-1.5 text-sm transition-[color,scale] active:scale-[0.98] dark:text-oklch(0.708 0 0) dark:hover:text-oklch(0.985 0 0)",
        className
      )}
      {...props}>
      <BrainIcon
...
function ReasoningContent({
  ...
  return (
    <CollapsibleContent
      ...
      className={cn(
        "aui-reasoning-content text-oklch(0.556 0 0) relative overflow-hidden text-sm outline-none dark:text-oklch(0.708 0 0)",
